...
g++ -shared -fPIC -I . -I tools/ -F ~/Library/Frameworks -framework SDL2 -I ~/Library/Frameworks/SDL2.framework/Headers -framework OpenGL -o NGL.so libz/OpenGLLib.cpp tools/Vector2.class.cpp tools/Vector3.class.cpp
