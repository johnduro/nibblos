...
float *SceneOpenGL::getTheFucknColor(float r, float g, float b, float a)
{
...
void SceneOpenGL::drawVox(Vector3 p, int porn, int type) {
...
void SceneOpenGL::drawFace(Vector3 a, Vector3 b, Vector3 c, Vector3 g, Vector3 h, float echelle) {
	GLfloat vertices[] =
	{
...
void SceneOpenGL::printMap(TMap & map) const {
